...
function HeroSection() {
  return (
    ...
    justify-center relative overflow-hidden mx-auto py-10 md:py-0 mt-30"
    >
         <Spotlight 
      ...
      <div className="p-4 relative z-10 w-full text-center">
        ...
        <div className="mt-4">
          <Link href="/courses">
           ...
           className="bg-white dark:bg-slate-900 text-md  text-black dark:text-white border-neutral-200 dark:border-slate-800">
                Explore courses
            </Button>
          </Link>
        </div>
