...
export const Menu = ({
  ...
  return (
    <nav
      onMouseLeave={() => setActive(null)} // resets on hover out
      className="relative rounded-full border border-transparent dark:bg-black dark:border-white/20 bg-white shadow-input 
                 flex justify-center gap-x-10 px-8 py-6"
    >
      {children}
    </nav>
  );
...
export const HoveredLink = ({
  ...
  return (
    <a
      {...rest}
      className="block px-3 py-1 rounded-md transition-all duration-300
